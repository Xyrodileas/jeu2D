...
/**
 * Classe de testant les m�thodes de la classe CollectionJoueur
 * 
 * @author David
 * 
 */
...
public class CollectionJoueurTest {
	 ...
	 * s'assurant que le constructeur cr�ait bien un objet du type
	 * CollectionJoueur
	 */
	@Test
	...
	/**
	 * Permet de tester la m�thode ajouterJoueur.
	 */
	@Test
	...
	public void testgetNbJoueur() {
		...
		CollectionTest.ajouterJoueur(JoueurTest);
		CollectionTest.ajouterJoueur(JoueurTest);
		assertEquals(CollectionTest.getNbJoueur(), 4); // On vérifie que la collection contient bien 4 joueurs
    ...
    public void testresetScore(){
        ...
        Joueur J3 = new Joueur("Cléopatre");
        Joueur J4 = new Joueur("César");
