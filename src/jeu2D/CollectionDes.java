...
/**
 * CollectionDes qui va permettre de stocker les des des joueurs
 * 
 */
public class CollectionDes<De> implements Iterable<De> {
	...
	/**
	 * Constructeur : CollectionDes Permet de cr�er une collection vide de des
	...
	/**
	 * Constructeur : CollectionDes Permet de cr�er une collection avec des dés
	 */
	...
	/**
	 * Permet d'ajouter un de � la collection selon le nombre de face souhait�
	 * 
	 * @param faces
	 */
	...
	/**
	 * Permet de retourner le nombre de des de la collection
	 * 
	...
	/**
	 * Permet d'instancier un it�rateur sur la Collection de De
	 */
	@Override
	public Iterator<De> iterator() {
		return new Iterator<De>() {
			...
			/**
			 * Permet de retourner le De suivant dans le vecteur de De
			 * (Collection)
			 * 
			 * Consequent : si il n'y a pas de suivant il leve une exception qui
			 * directement gerer en retournant un boolean false sinon si suivant
			 * existe alors retourne vrai
			 */
			@Override
			...
			/**
			 * Permet de se positionner la position courante et de renvoyer l
			 * element ( le De)
			 */
			@Override
			public De next() {
