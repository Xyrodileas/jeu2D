...
Nom du fichier: FabriqueDe.java
...
/**
 * Classe : public class Permet de fabriquer les des souhaites
 * 
 */
...
public class FabriqueDe {
	...
	/**
	 * Permet de construire un de 6 face par defaut et le retourne
	 * 
	 * @return De
	 */
	...
	/**
	 * Permet de creer un De selon le nombre de face souhaite
	 * 
	 * @param nbFace
	...
	/**
	 * Methode qui permet de retourner un tableau de des
	 * 
	 * @param nbDe
	 *            (Nombre de de voulu)
	 * @param nbFaces
	 *            (Nombre de face souhaite)
	 * @return De[] tabDe
	 */
